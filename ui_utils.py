...
ACLARACIONES_CARACTERISTICAS = {
    ...
    "*Preparación de muestra FTIR-Cloroformo: colocar 0,45 g muestra en un balon aforado de 10 mL. Enrasar con cloroformo seco (secado con NaSO4 anhídro). Almacenar en botellas 10 mL bien tapadas y refrigerar. El cloroformo es muy volátil y ebulle a 61°C.*",

...
with tab2:
    st.title("Análisis de datos")
    st.info("Contenido de la Hoja 2 en construcción...")


with tab3:
    st.title("Carga de espectros")
    st.info("Contenido de la Hoja 3 en construcción...")
...
tab1, tab2, tab3, tab4, tab5, tab6 = st.tabs(["Laboratorio de Polioles", "Análisis de datos", "Carga de espectros", "Análisis de espectros", "Sugerencias", "Consola"])
